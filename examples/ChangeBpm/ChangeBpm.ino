 ...
 * 
 * In this example, Button A is used to control music playback and stop. 
 * Button B increases the tempo, and Button C decreases the tempo. 
 * The step size for increasing and decreasing can be found in the SAM2695_Def.h file, and it can be modified.
 */
